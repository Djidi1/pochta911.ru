        ...
        <table class="table table-striped table-hover table-bordered new-logist-data-table">
            ...
            <tbody>
                <xsl:for-each select="orders/item/route/array">
                    <tr onclick="open_bootbox_dialog('/orders/order-{../../id}/');" style="cursor:pointer">
                        ...
                        <td class="hide-mobile">
                            <nobr>
                                <xsl:value-of select="../../time_ready_from"/>-<xsl:value-of select="../../time_ready_end"/>
                            </nobr>
                        </td>
                        <td><nobr>
                        ...
                        <td class="hide-mobile">
                            <xsl:value-of select="../../from_comment"/>
                        </td>
